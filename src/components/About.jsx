...
const About = () => {
  return (
    <>
        <div className="w-full h-screen bg-gradient-to-b  to-black  from-gray-800 px-3"  name="about">
            <div className="max-w-screen-lg mx-auto h-full flex flex-col justify-center content-between">
                <div className="w-full">
                    <div className="text-center mb-20">
                        <h1 className="text-white text-4xl sm:text-6xl uppercase font-bold mb-4">about</h1>
